...
const experience = [
  {
    ...
    description: [
      ...
      "Engineered an Infra Cloud Bot on MS Teams using Teams AI Library(TypeScript), GPT-4o with advanced prompting to create an LLM-driven assistant for cloud operations with role-based approval workflows; reduced manual effort by 45%.",
