...
const experience = [
  {
    ...
    description: [
      ...
      "Architected cloud infrastructure with automatic failover and DR using Terraform, ECS(Fargate) ensuring uninterrupted operations.",
      ...
      "Designed scalable AI architectures handling 50 Million + TPM and 500K+ requests, integrating multi-LLM platforms across Azure OpenAI and GCP Vertex AI (Llama, Gemini, Claude), deployed regionally with APIM for low-latency analytics bots.",
      "Architected a multi-tenant ML inference platform on EKS and Amazon SageMaker, handling 10K+ real-time voice inference requests/day, achieving sub-100 ms latency with tenant isolation and autoscaling",
      ...
      "Achieved 98.7% pipeline success rate with 500+ daily executions through comprehensive CloudWatch monitoring and automated testing workflows",
      "Authored cloud and AI platform architecture designs, technical proposals, guiding teams on future-state platform strategy",
    ],
